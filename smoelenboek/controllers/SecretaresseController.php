...
class SecretaresseController
{
    ...
    */
            ...
            if($_POST['search']) {
                ...
                switch($result) {
                    case REQUEST_SUCCESS:
                        $this->view->set('boodschap','Search');
                        break;
                    ...
                    case REQUEST_NOTHING_CHANGED:
                        $this->view->set('boodschap', 'Er was niets te vinden');
                        $result = NULL;
                        break;
    ...
    private function anwAction() {
        if($this->model->isPostLeeg()) {
           $this->view->set("boodschap","Wijzig hier je gegevens");
            ...
            $result = $this->model->wijzigAnw(false);
            switch($result) {
                case REQUEST_SUCCESS:
    ...
    private function afdelingAction() {
        ...
        if($this->model->isPostLeeg()) {
           $this->view->set("boodschap","Wijzig hier je gegevens");
            ...
            $result = $this->model->wijzigAfdeling();
            $afdelingen = $this->model->getAfdelingen();
            switch($result) {
                case REQUEST_SUCCESS:
                    $this->view->set('boodschap','wijziging gelukt');
    ...
    private function directeurAction() {
        if($this->model->isPostLeeg()) {
           $this->view->set("boodschap","Wijzig de gegevens van de directeur hier");
        } else {
            $result = $this->model->wijzigAnw(true);
            switch($result) {
                case REQUEST_SUCCESS:
                    $this->view->set('boodschap','wijziging gelukt');
                    break;
    ...
    private function updateAction() {
        if($this->model->isPostLeeg()) {
           $this->view->set("boodschap","Wijzig hier je gegevens");
            ...
            $result = $this->model->updateAnwMedewerker();
            switch($result) {
                case REQUEST_SUCCESS:
                    $this->view->set('boodschap','Wijziging gelukt');
                    break;
        ...
        $gebruiker = $this->model->getGebruiker();
        $medewerker = $this->model->getMedewerker();
        $this->view->set('gebruiker',$gebruiker);
        $this->view->set('medewerker', $medewerker);
    }
}
