        <footer>
            <div class="container-fluid ">
                <div class="row">
                    <div class="col-md-12 footer__wrapper">
                        ...
                        <div class="d-flex flex-row justify-content-end flex-wrap">
                            ...
                            <i class="fa fa-twitter-square fa-3x p-2 tt-blue" aria-hidden="true"></i>
                            <i class="fa fa-facebook-square fa-3x p-2 fb-blue" aria-hidden="true"></i>
                            <i class="fa fa-youtube-square fa-3x p-2 yt-red" aria-hidden="true"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="js/modules/ImageModule.js"></script>
